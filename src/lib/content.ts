...
export const episodes: Episode[] = [
  {
    ...
    thumbnail: "https://placehold.co/800x450/E91E8C/FFFFFF?text=EP01",
...
export const members: Member[] = [
  {
    ...
    image: "https://placehold.co/400x400/1A1A1A/FFFFFF?text=AI+Coach",
  },
  {
    id: "m02",
    name: "",
    ...
    image: "https://placehold.co/400x400/E91E8C/FFFFFF?text=FM+Staff",
  },
  {
    id: "m03",
    name: "",
    role: "AIコーチング受講 / 出演",
    affiliation: "株式会社エフエム大阪",
    image: "https://placehold.co/400x400/00AEEF/FFFFFF?text=Cast",
  },
];
